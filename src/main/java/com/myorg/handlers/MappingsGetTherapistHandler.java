...
public class MappingsGetTherapistHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {

    private final DynamoDB dynamoDB;
    private final String mappingsTable;
    private final Gson gson = new Gson();

    public MappingsGetTherapistHandler() {
